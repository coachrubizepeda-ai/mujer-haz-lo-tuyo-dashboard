// netlify/functions/lineamientos-operativos-set.js
//
// Guarda los "Lineamientos operativos para facilitadores" completos
// (arreglo de [titulo, texto]) — se edita desde Facilitador o
// Administradora y queda visible de inmediato, para todas, en los 3
// portales.
//
...
exports.handler = async (event) => {
  ...
  try {
    ...
    await store.setJSON("operativos", registro);
