// netlify/functions/lineamientos-facilitadores-set.js
//
// Guarda el "Código de Honor para facilitadores" completo (arreglo de
// [titulo, texto]) — se edita desde Facilitador o Administradora y queda
// visible de inmediato, para todas, en los 3 portales.
//
...
exports.handler = async (event) => {
  ...
  try {
    ...
    await store.setJSON("facilitadores", registro);
